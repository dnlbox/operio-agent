...
3. **The full conversational path is traceable and measurable.**
   - Each turn should carry session context, retrieval evidence, tool calls, and a resolution outcome so Phoenix can evaluate the conversation, not just the final answer.
